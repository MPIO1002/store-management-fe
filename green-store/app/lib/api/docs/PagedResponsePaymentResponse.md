...
------------ | ------------- | ------------- | -------------
**items** | [**Array&lt;PaymentResponse&gt;**](PaymentResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PagedResponsePaymentResponse } from './api';

const instance: PagedResponsePaymentResponse = {
    items,
    pageNumber,
    pageSize,
    totalItems,
